    ...
    <main className="min-h-screen overflow-hidden bg-[#fbf7f0] text-[#2b2420]">
      ...
      <section id="top" className="relative mx-auto overflow-hidden bg-[#f4e8da] px-6 pb-20 pt-10 text-[#2b2420] lg:px-10 lg:pb-28 lg:pt-14">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          <h1 className="mx-auto max-w-4xl text-[clamp(3.1rem,8vw,7rem)] font-semibold leading-[.92] tracking-[-0.075em]">Miejsce, gdzie marki<br /><span className="text-[#c85e40]">spotykają właściwych twórców.</span></h1>
      ...
      <section className="px-6 pb-24 lg:px-10"><div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 rounded-[2rem] bg-[#f0d5b9] p-8 sm:p-12 lg:flex-row lg:items-end"><div><p className="kinvo-section-label mb-4 text-[#a7533d]">Startujemy wkrótce</p><h2 className="max-w-2xl text-4xl font-semibold leading-tight tracking-[-.055em] sm:text-5xl">Bądź blisko początku<br />czegoś <span className="text-[#b6533d]">dobrego.</span></h2><p className="mt-4 max-w-md text-sm leading-6 text-[#76584a]">Zarezerwuj miejsce w pierwszej edycji Kinvo. Pierwsze osoby dostaną dostęp za 0 zł.</p></div><a href="#waitlist" className="shrink-0 rounded-full bg-[#2b2420] px-6 py-4 text-sm font-semibold text-white hover:bg-[#4b3930]">Zarezerwuj dostęp <ArrowUpRight className="ml-1 inline" size={16} /></a></div></section>
